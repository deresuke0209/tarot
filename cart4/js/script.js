  ...
  speedRandom1 = Math.floor( Math.random()*5 +1 );
   down1 = setInterval(function(){
     if($('.enemy1').hasClass("death")){
       enemyDown1 -= Math.abs(speedRandom1 - 6);;
     }else{
  ...
  speedRandom2 = Math.floor( Math.random()*5 +1 );
   down2 = setInterval(function(){
     if($('.enemy2').hasClass("death")){
       enemyDown2 -= Math.abs(speedRandom2 - 6);;
     }else{
  ...
  speedRandom3 = Math.floor( Math.random()*5 +1 );
   down3 = setInterval(function(){
     if($('.enemy3').hasClass("death")){
       enemyDown3 -= Math.abs(speedRandom3 - 6);;
     }else{
  ...
  speedRandom4 = Math.floor( Math.random()*5 +1 );
   down4 = setInterval(function(){
     if($('.enemy4').hasClass("death")){
       enemyDown4 -= Math.abs(speedRandom4 - 6);;
  ...
  speedRandom5 = Math.floor( Math.random()*5 +1 );
   down5 = setInterval(function(){
     if($('.enemy5').hasClass("death")){
       enemyDown5 -= Math.abs(speedRandom5 - 6);;
     }else{
...
$("#use-button , #item-box").click(function(){
  if($("#item-box").hasClass("rock")){
    return;
  }else if(mario.hasClass("out")){
    return;
  }else{
    $("#item-box").addClass("rock");
    $("#item-img").hide();
...
storageRecord1 = Number(localStorage.getItem('recordlist1'));
storageRecord2 = Number(localStorage.getItem('recordlist2'));
storageRecord3 = Number(localStorage.getItem('recordlist3'));

$("#recordTime1").text(storageRecord1);
$("#recordTime2").text(storageRecord2);
$("#recordTime3").text(storageRecord3);

let recordTime1 = Number($("#recordTime1").text());
let recordTime2 = Number($("#recordTime2").text());
let recordTime3 = Number($("#recordTime3").text());



  $("#result").click(function(){
    if(nowCount >=recordTime1){
      localStorage.setItem('recordlist1', nowCount);
      localStorage.setItem('recordlist2', recordTime1);
      localStorage.setItem('recordlist3', recordTime2);
      storageRecord1 = Number(localStorage.getItem('recordlist1'));
      storageRecord2 = Number(localStorage.getItem('recordlist2'));
      storageRecord3 = Number(localStorage.getItem('recordlist3'));
      $("#recordTime1").text(storageRecord1);
      $("#recordTime2").text(storageRecord2);
      $("#recordTime3").text(storageRecord3);
      $('.new-record').text("New Record!");
      setInterval(function() {
         $("#recordTime1").fadeOut(400, function() {
           $(this).fadeIn(400);
         });
      }, 800);
    }else if(nowCount >= recordTime2){
      localStorage.setItem('recordlist2', nowCount);
      localStorage.setItem('recordlist3', recordTime2);
      storageRecord2 = Number(localStorage.getItem('recordlist2'));
      storageRecord3 = Number(localStorage.getItem('recordlist3'));
      $("#recordTime2").text(storageRecord2);
      ...
      $('.new-record').text("New Record!");
      setInterval(function() {
         $("#recordTime2").fadeOut(400, function() {
           $(this).fadeIn(400);
         });
      }, 800);
    }else if(nowCount >= recordTime3){
      localStorage.setItem('recordlist3', nowCount);
      storageRecord3 = Number(localStorage.getItem('recordlist3'));
      $("#recordTime3").text(storageRecord3);
      $('.new-record').text("New Record!");
      setInterval(function() {
         $("#recordTime3").fadeOut(400, function() {
           $(this).fadeIn(400);
         });
      }, 800);
    }
    ...
    setTimeout(function(){
     recordCount = setInterval(function(){
       ...
       if(rCount >= nowCount){
         ...
         setTimeout(function(){
           $(".new-record").slideDown();
         },1000);

         setTimeout(function(){
           $(".score-title").show();
           setInterval(function() {
              $(".new-record").fadeOut(400, function() {
                $(this).fadeIn(400);
              });
           }, 800);
         },2000);
